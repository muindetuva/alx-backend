#!/usr/bin/env python3
"""
Server module to paginate a database of popular baby names with
hypermedia metadata.
"""
...
def index_range(page: int, page_size: int) -> Tuple[int, int]:
    ...
    Returns:
        ...
        range of items to return for the specified page.
    """
...
class Server:
    ...
    def dataset(self) -> List[List]:
        ...
        Returns:
            List[List]: The cached dataset with the header removed.
        """
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> Dict[str, Any]:
        """
        Get a page and return hypermedia-style pagination metadata.
        ...
        Returns:
            Dict[str, Any]: A dictionary containing metadata and data for the
            current page.
        """
